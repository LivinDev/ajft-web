...
const formSchema = z.object({
  ...
  occupation: z.string().min(1, 'Address is required'),
  date: z.string(),
  gender: z.string(),
});
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className={styles.formContainer}>
      ...
      <div className={styles.flexrow}>
        ...
        <div className={styles.formGroup}>
          ...
          <input
            id="occupation"
            {...register('occupation')}
            placeholder="user@occupation.com"
            className={styles.input}
          />
          {errors.email && (
            <p className={styles.errorMessage}>{errors.occupation?.message}</p>
          )}
        </div>
      </div>
      <div className={styles.flexrow}>
      ...
      <div className={styles.formGroup}>
        ...
        />
        {errors.message && (
          <p className={styles.address}>{errors.address?.message}</p>
        )}
      </div>
      <div className={styles.formGroup}>
